...
<body>
     ...
     <%
             String ss=(String)session.getAttribute("session1");
             System.out.println(ss);
             String s1=request.getParameter("tt1");
             String s2=request.getParameter("tt2");
             String s3=request.getParameter("tt3");
             String s4=request.getParameter("tt4");
             System.out.println("email"+s1);
             System.out.println("name"+s2);
             System.out.println("mob_no"+s3);
             ...
             try{
              ...
              PreparedStatement st1= con.prepareStatement("update sign_up set email='"+s1+"', name='"+s2+"', mob_no="+s3+", address='"+s4+"' where email='"+ss+"'");
   
              st1.executeUpdate();
              //response.sendRedirect("myprofile.jsp");
              PreparedStatement st2= con.prepareStatement("update login set email='"+s1+"', password='"+s4+"' where email='"+ss+"'");
